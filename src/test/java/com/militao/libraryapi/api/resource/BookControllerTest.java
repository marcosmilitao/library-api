...
import com.militao.libraryapi.service.BookServiceTest;
...
public class BookControllerTest {
    ...
    public void createBookTest() throws Exception {
        ...
        BookDTO dto = BookDTO.builder().author("Marcos").title("Hope").isbn("001").build();

        Book savedBook = Book.builder().id(10l).author("Marcos").title("Hope").isbn("001").build();
